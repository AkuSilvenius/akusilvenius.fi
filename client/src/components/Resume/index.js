...
export default class index extends Component {
    render() {
        let comps = [
            <div key="ResumeScroll" id="scroll">
                <ScrollableCard idx={0} pageName="Resume">
                    <SkillHighlights props={this.props} />
                </ScrollableCard>
                <ScrollableCard idx={1} pageName="Resume">
                    <TechSkills props={this.props} />
                </ScrollableCard>
            </div>,
        ];

        return <div id="Resume">{comps}</div>;
    }
}

function SkillHighlights(params) {
    return <p>{params.props.t('sections.Resume.overview')}</p>;
}

function TechSkills(params) {
    return (
        <div id="ResumeTechSkills">
            <div className="frontendSkills">
                <div className="techSkillTitle">
                ...
                <div className="techSkillContent"></div>
            </div>
            <div className="backendSkills">
                <div className="techSkillTitle"></div>
                <div className="techSkillContent"></div>
            </div>
